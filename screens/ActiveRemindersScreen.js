...
const ActiveRemindersScreen = () => {
  ...
  useEffect(() => {
    ...
    // Fetch user role (caregiver or patient)
    ...
    // Fetch paused reminders for the current user
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.tagline}>
        Easily activate or pause your reminders to stay on top of your daily tasks.
      </Text>
      ...
      {isCaregiver && (
        ...
        <TouchableOpacity 
            style={styles.button} 
            onPress={() => navigation.navigate('PatientRemindersScreen')} // Navigate to Linked User Reminders Screen
          >
            <Text style={styles.buttonText}>View Linked User Reminders</Text>
          </TouchableOpacity>
          <Text style={styles.label}>Your Active Reminders</Text>
      ...
      <Text style={styles.encouragementText}>
        Stay organized and productive by managing your reminders efficiently.
      </Text>
    </View>
  );
}
...
const styles = StyleSheet.create({
  ...
  button: {
    backgroundColor: '#007b7f', // Teal color for button
    padding: 10,
    borderRadius: 5,
    alignItems: 'center',
    marginVertical: 10,
...
export default ActiveRemindersScreen;